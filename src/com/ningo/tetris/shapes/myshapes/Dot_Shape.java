...
public class Dot_Shape implements TetrisShape{
	...
	public Dot_Shape(int root_X,int root_Y)
	{
		this.root_X = root_X;
		this.root_Y = root_Y;
...
Color color = new Color(0x333399);
	...
	public boolean drop() {
		...
		if(!checkDownAvailable())
		{
			...
			TetrisMainPanel.accumulationMemoryMatrix[(sqr_1_root_X - TetrisMainPanel.ZERO_X)/TetrisMainPanel.BASIC_LENGTH][(sqr_1_root_Y - TetrisMainPanel.ZERO_Y)/TetrisMainPanel.BASIC_LENGTH] = "Dot_Shape_Color";
	...
	public boolean checkDownAvailable() {
		...
		if(sqr_1_root_Y +TetrisMainPanel.BASIC_LENGTH == TetrisMainPanel.BOTTOM_BORDER_Y)
		return false;
		
		
		if(TetrisMainPanel.latticeArray[(sqr_1_root_X - TetrisMainPanel.ZERO_X)/TetrisMainPanel.BASIC_LENGTH][(sqr_1_root_Y - TetrisMainPanel.ZERO_Y)/TetrisMainPanel.BASIC_LENGTH + 1] == 1 )
			return false;
	...
	public boolean checkLeftAvailable() {
		...
		if(sqr_1_root_X == TetrisMainPanel.LEFT_BORDER_X)
			return false;
		
		
		if(TetrisMainPanel.latticeArray[(sqr_1_root_X - TetrisMainPanel.ZERO_X)/TetrisMainPanel.BASIC_LENGTH - 1][(sqr_1_root_Y - TetrisMainPanel.ZERO_Y)/TetrisMainPanel.BASIC_LENGTH] == 1 )
			return false;
	...
	public boolean checkRightAvailable() {
		// TODO Auto-generated method stub
		if(sqr_1_root_X +TetrisMainPanel.BASIC_LENGTH == TetrisMainPanel.RIGHT_BORDER_X)
			return false;
	...
	public boolean can_to_sit_0() {
		...
		if(root_X < TetrisMainPanel.ZERO_X || root_X >  TetrisMainPanel.RIGHT_BORDER_X - TetrisMainPanel.BASIC_LENGTH || root_Y > TetrisMainPanel.BOTTOM_BORDER_Y - TetrisMainPanel.BASIC_LENGTH)
			return false;
