...
public class SmallS_Shape implements TetrisShape{
	...
	public SmallS_Shape(int root_X,int root_Y)
	{
		this.root_X = root_X;
		this.root_Y = root_Y;
...
Color color = new Color(0xcc6600);
	...
	public boolean drop() {
		...
		if(!checkDownAvailable())
		{
			...
			TetrisMainPanel.accumulationMemoryMatrix[(sqr_1_root_X - TetrisMainPanel.ZERO_X)/TetrisMainPanel.BASIC_LENGTH][(sqr_1_root_Y - TetrisMainPanel.ZERO_Y)/TetrisMainPanel.BASIC_LENGTH] = "SmallS_Shape_Color";
			TetrisMainPanel.accumulationMemoryMatrix[(sqr_2_root_X - TetrisMainPanel.ZERO_X)/TetrisMainPanel.BASIC_LENGTH][(sqr_2_root_Y - TetrisMainPanel.ZERO_Y)/TetrisMainPanel.BASIC_LENGTH] = "SmallS_Shape_Color";
